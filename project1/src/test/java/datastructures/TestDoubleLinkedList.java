...
public class TestDoubleLinkedList extends BaseTest {
     ...
     * constructor directly. Our private tests rely on this method.
     */
    ...
    /**
     * This method creates a simple list containing three elements to help minimize redundancy later in our tests.
     *
    ...
    /**
     * This test will check if a list contains exactly the same elements as the "expected" array. See the tests you were
     * provided for example usage.
     *
     ...
     *
     * One second is typically extremely generous: most of your tests should finish in milliseconds. If one of your
     * tests is timing out, you're almost certainly doing something wrong.
     */
    ...
    public void testDeleteBadInput() {
        ...
        // index = size for list with lots of elements
        try {
        ...
        // index < 0 for list with lots of elements
        try {
            list.delete(-20);
            fail("Expected IndexOutOfBoundsException");
        } catch (IndexOutOfBoundsException e) {
    ...
    @Test
    public void testBeforeAfterDeleteListState() {
        IList<String> list = this.makeBasicList();
        ...
        this.assertListMatches(new String[] {"a", "b", "c", "d", "e", "g"}, list);

        list.delete(4);
        assertEquals(5, list.size());
        this.assertListMatches(new String[] {"a", "b", "c", "d", "g"}, list);

        list.delete(1);
        assertEquals(4, list.size());
        this.assertListMatches(new String[] {"a", "c", "d", "g"}, list);

        // boundary case state when one element
    ...
    public void testIndexOfAndContainsMany() {
        ...
        // every time we run this test. This helps us keep our tests deterministic,
        // which
